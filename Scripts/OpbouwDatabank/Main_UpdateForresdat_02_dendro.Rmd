...
head(dendro_by_plot %>% arrange(desc(plot_id), period) %>% filter(plot_id == 2010)); 
head(dendro_by_plot_git %>% arrange(desc(plot_id), period) %>% filter(plot_id == 2010))

# LIS is anders, is nu foutief 0 !!!

waldo::compare(dendro_by_plot %>% filter(plot_id == 2010), dendro_by_plot_git %>% filter(plot_id == 2010))
# afronding is anders 
