...
## Intacte bomen - correctie mbv R-code (voorlopig)
...
> Issue # 105 aangemaakt in forrescalc. Zal geïmplementeerd worden.
...
- Héél uitzonderlijk in 3e SET: 2 bomen in KV *Rodebos* (plot 43000 - volledig binnen plot)
...
dendro_by_plot %>% select(-year) %>% arrange(plot_id) == dendro_by_plot_git %>% select(-year) %>% arrange(plot_id)
