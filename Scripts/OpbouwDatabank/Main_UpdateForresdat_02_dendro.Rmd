...
# CORRECTIE liggend dood hout - Zoniën KERN_1983 & UITBR_1995 
...
## CP's Zoniën KERN_1983 & Zoniën UITBR_1995 - periode 1
...
## KV Zoniën KERN_1983 - periode 2 & 3
...
géén variabele `vol_log_m3_ha_min40cm` nodig, zorgen dat `vol_log_m3_ha` en `vol_deadw_m3_ha` 
NA zijn voor de diam-klasses 10-15cm/15-20cm/20-25cm/25-30cm/… 


```{r corr_data_met_diam}
# diam
names(dendro_by_diam_plot)
unique(dendro_by_diam_plot$dbh_class_5cm)
kleiner_dan_40 <- c("5 - 10 cm", "10 - 15 cm", "15 - 20 cm", "20 - 25 cm"
                    ,"25 - 30 cm", "30 - 35 cm", "35 - 40 cm")
# dbh_class_5cm
dendro_by_diam_plot_ <- dendro_by_diam_plot %>% 
  mutate(vol_log_m3_ha = 
           ifelse(plot_id == 11000 & dbh_class_5cm %in% kleiner_dan_40
                  , NA, vol_log_m3_ha)
         , vol_deadw_m3_ha = 
           ifelse(plot_id == 11000 & dbh_class_5cm %in% kleiner_dan_40
                  , NA, vol_deadw_m3_ha)
