---
title: "Dendro Zoniën KERN_1983 - survey 2000"
subtitle: "Geturfde bomen < 30 cm dbh"
author: "Anja Leyman"
date: "`r Sys.Date()`"
output: 
  html_document:
...
In grafiek 2.11 van het monitoringrapport wordt wel een stamtal weergegeven van de lagere diameterklasses: visuele inschatting: 
25 + 90 + 100 = 215 extra
...
In grafiek 2.11 van het monitoringrapport uit 2002 wordt een stamtal weergegeven van de 
lagere diameterklasses.
Visuele inschatting: 25 + 90 + 100 = ca 215/ha (dbh < 30 cm).
...
- alles < 30 cm (uit streeplijsten; enkel levende bomen)
  ...
  * in afzonderlijke files met net iets andere diameterverdeling (5-10, 10-20, 20-30cm):

      * Kerss_CA_5_30cm_by_plot(_species).csv
      * Kerss_CA_5_30cm_by_diam_plot.csv
      * Kerss_CA_5_30cm_by_diam_spec.csv
...
```{r list}
dendro <- list(
      Kerss_CA_5_30cm_by_plot = by_plot,
      Kerss_CA_5_30cm_by_plot_species = by_plot_species,
      Kerss_CA_5_30cm_by_diam_plot = by_diam_plot,
      Kerss_CA_5_30cm_by_diam_spec = by_diam_plot_species
    )
```
...
source_file <- here::here(paste0("Scripts/OpbouwDatabank/Aanvulling_forresdat_ZonienKERN_1983_survey2000.html"))
