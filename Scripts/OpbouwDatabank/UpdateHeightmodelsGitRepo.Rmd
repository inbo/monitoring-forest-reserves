...
**BELANGRIJK**: naam van files moeten strikt bestaan uit HeightParams, naam reservaat 
(zonder inderscores!!), plottype (!! CA of CP), periode.      
Anders werk functie `load_heightmodels()` niet
