...
# allemaal coppice, wellicht correcties
# ervan uitgaan dat meest recente databank de correcte is

#--------
stems_old <- read.csv2(file = paste0(path_to_treelevel_csv, "stems_calc.csv"))          
nrow(stems_old) - nrow(data_stems_calc) == 0 #-321
