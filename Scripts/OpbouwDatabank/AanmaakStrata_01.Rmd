...
forest_reserve_info_EUFORIA <- forest_reserve_info_EUFORIA_
```
...
- forest_reserve_info_EUFORIA (opp. volledig reservaat, forest type, mean annual temp/precipitation)
...
strata <- list(
      ...
      forest_reserve_info_EUFORIA = forest_reserve_info_EUFORIA
    )
