...
Kris gaat afstemmen tss tabel en monitoringrapport (zie mail van 5/12/2024)
...
con <- odbcConnectAccess2007(path_to_strata_db)
  management_monitoringrapport <- sqlFetch(con, "info_forest_reserve_management", stringsAsFactors = FALSE)  # reserve establishment date
odbcClose(con)
...
corrigeren en beter afstemmen tss tabel (`plot_unmanaged_since`) en monitoringrapport (`reserve_unmanaged_since`) 
