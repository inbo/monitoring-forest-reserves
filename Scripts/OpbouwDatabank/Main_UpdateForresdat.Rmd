...
con <- odbcConnectAccess2007(path_to_fieldmap_db)
  ...
  qCondLUVdagnVfm <- sqlFetch(con, "qCondLUVdagnVfm", stringsAsFactors = FALSE)
...
list_lkp <- list(qIndShootCop = qIndShootCop, qAliveDead = qAliveDead, qSpecies = qSpecies, 
                 ...
                 qCondLUVdagnVfm = qCondLUVdagnVfm,
...
# Dendro - voorlopig OK - 25/11/2022
...
Dat doen we hier mv een updatequery, nadat we zeker zijn dat de waardes correct 
...
dendro_by_plot_ <- dendro_by_plot %>% 
  replace((is.na(.)), 0) %>% 
  mutate(vol_deadw_m3_ha = vol_log_m3_ha)
...
is he twel nuttig bij `dendro_per_plot`.
...
## Deadwood KV Kersselaerspleyn pas vanaf 40 cm

Geen opnames in 1ste decade (reeds op NA gezet hierboven)
