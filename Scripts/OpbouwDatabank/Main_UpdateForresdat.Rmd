...
gdrive_path  <- "G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dQ2w5ZFhSZEpCU0E/PRJ_BOSECO_ALGEMEEN/PRJ_BR_AanvraagGegevens/!METADATA-ALL_PLOTS/forresdat_data/csv/"

# test <- read.csv2(paste0(gdrive_path, "dendro_by_diam_plot.csv"))
