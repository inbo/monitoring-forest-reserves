...
- BR_analysedb.accdb
- output-folders "_plot-level-data" en "_tree-level-data"
- gdrive-folders "_plot-level-data" en "_tree-level-data"
...
## Rechtstreeks van fieldmap-db naar forresdat
...
24/9 mail naar ELs L.

Els, 

beide functies ("from_forresdat_to_access" & "save_results_access") werken niet bij mij:
er wordt telkens maar één tabel weggeschreven (de eerste uit de lijst)
én de foutmelding is twee keer dezelfde "Error: nanodbc/nanodbc.cpp:1777: HYC00
[Microsoft][ODBC Microsoft Access-stuurprogramma]De optionele voorziening is niet geïmplementeerd"
...
## Export naar teamdrive

Kopiëren naar teamdrive "PRJ_BR_AanvraagGegevens\00_METADATA-ALL_PLOTS\_qXX_lookuplijsten".
