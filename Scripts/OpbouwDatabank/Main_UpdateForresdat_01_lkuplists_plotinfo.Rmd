...
nrow(plotinfo) # 2629 / 2628?

plotinfo %>% 
  filter(survey_trees == FALSE & data_processed == TRUE) %>% nrow()
t <- plotinfo %>% 
...
Bos Terrijst en Coolhem: nog niks mee gedaan, ook geen datacontrole
