...
In onderstaand script wordt hier abstractie van gemaakt.

In een tweede script worden deze uitzonderingen aangepast
> Of helemaal onderaan allemaal samen??
...
Kerss CP's deadwood 1eSET (2000): uitgevoerd, maar niet geïmporteerd in FieldMap.
Verwerkt door Luc DK ikv eerste monitoringrapport.

Hierna survey_deadw op TRUE zetten

```{r CORRECTIE_survey_deadw_CP_Kerss}
...
## Deadwood (intact/fragment) volume bijwerken - OK - 23/11/2022
...
Afgesproken met Peter:  
  - sowieso alle met decay 14 of 15 = fragment   
  - decay 13: enkel deze met min_diameter > 150 (dat zijn 18 bomen van de 42 met decay 13)
  
<!-- ofwel allemaal fragment -->
<!-- ofwel enkel deze met min_diameter > 100? (dat zijn 33 bomen van de 42 met decay 13) -->

Peter ging dit aanpassen in de databank, maar nog niet gebeurd vrees ik.
...
# !! soms calc_length (inside plot) veel kleiner dan total_length (in- and outside plot) => dan mag intact zeker niet
...
Niet geweten hoeveel er in welke diameterklasse zit => daar wel NA zetten
