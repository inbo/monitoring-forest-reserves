...
> dit kan pas eens forresdat op zenodo staat, nu nog in develop branch bezig (10/2/2026)
Daarom nu nog via `read_forresdat_table()`
...
# Inladen plotinfo en strata

OPGEPAST: sommige plots nog beheerd na start van monitoringnetwerk

```{r read_forresdat2}
tablenames_input <- c("plotinfo", "strata_remaining", "plots_excluded_from_network")
...
# plots_excluded_from_network <- sqlFetch(con, "plots_excluded_from_network", stringsAsFactors = FALSE)
# # = plots waar beheer gebeurd is ergens na start van monitoringnetwerk
# odbcClose(con)
