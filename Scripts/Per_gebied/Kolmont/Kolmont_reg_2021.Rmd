...
data_regeneration %>% filter(!is.na(nr_of_regeneration) & !is.na(number_class)) %>% 
  nrow() == 0
# OK, één van beide, niet allebei
...
n_distinct(data_regeneration$plot_id) == nrow(plotinfo)
...
source_file <- here::here(paste0("Scripts/Per_gebied/", forestreserve_short, "/", forestreserve_short, "_reg_2021.html"))
