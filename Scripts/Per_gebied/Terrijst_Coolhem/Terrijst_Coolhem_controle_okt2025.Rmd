...
subtitle: "Terrijst & Coolhem - cirkelplots & kernvlakte"
author: "Anja Leyman"
date: "`r Sys.Date()`"
output: 
  html_document:
...
```{r Setup2}
forestreserve <- c("Bos Terrijst", "Coolhem Q", "Coolhem A")   # FM-project onder folder Terrijst geplaatst
forestreserve_short <- "Terrijst" # om paths aan te maken naar specifieke folders
...
TIJDELIJK `path_to_fieldmap_db` aanpassen naar de werkversie van Terrijst en Coolhem
...
```{r eval = FALSE}
# Specify the path of the file you want to copy
source_file <- here::here(paste0("Scripts/Per_gebied/Terrijst_Coolhem/", "Terrijst_Coolhem_controle_okt2025.html"))
