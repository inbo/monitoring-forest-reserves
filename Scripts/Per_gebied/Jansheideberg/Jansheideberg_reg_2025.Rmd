...
check_subplot78 <- reg_by_core_area_height_species %>% 
  ...
  filter(game_impact_reg == TRUE) 
# verwarrend: er is ""n subplot met species = NA in hoogteklasse 1000
# het lijkt in deze outputalsof er één subplot is waar geen soort genoteerd werd, maar dat is niet correct
# => in db leeg recodr verwijderd
