...
In `r forestreserve` zijn er `r nrow(open_ruimte)` open ruimtes
...
- enkel cirkelplots   
- zonder de open ruimte: dat zijn `r nrow(open_ruimte)` plots in geval van 
`r forestreserve`.
