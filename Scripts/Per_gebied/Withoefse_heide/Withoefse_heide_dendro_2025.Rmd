...
Er zijn 4 plots (201, 202, 203 en 208) waar geen opnames gebeurd zijn => in moederdatabank "non_processed".
...
## Fragmenten - update van volume in FM - ok voor "DB_BR_X8_inbo2020_20250123"
...
Op 19/12/2025 nog een bug in forrescalc die ervoor zorgt dat volume logs in
diameterklasse 5-10cm op 0 gezet wordt, terwijl er pas gemeten wordt vanaf 10 cm

Zie [issue 172](https://github.com/inbo/forrescalc/issues/172)

Hierna tijdelijke correctie.
Eigenlijk niet nodig bij With heide, want treshold is ook voor staande bomen 10 cm

```{r TEMP_corr_logs_5_10cm, results='hide', eval = FALSE}
# dataframes mét info over diameterklasse: `vol_log_m3_ha` op NA zetten in de
# diameterklasse 5-10 cm

corr_list <- list(dendro_by_diam_plot = dendro_by_diam_plot
...
tbls <- map(corr_list, \(x) correctie_logs(x))
