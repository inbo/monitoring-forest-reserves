...
<!-- Gevraagd aan Peter (mail 19/11/25), moet NA zijn (antw 20/11/2025) -->
<!-- Op 24/11/2025 in moederdb-en op mijn c-schijf (en bij Peter) `survey_reg_YN = FALSE`  -->
<!-- in plotdetails_2eSET. -->
<!-- Code al opnieuw gerund, is OK met die aanpassing in plotdetails -->
...
# plot 212: reg niet genoteerd in periode 2 
# aangepast in plotdetails_2eSET (24/11/2025): is nu NA 
...
dataset4_0 <- add_zeros(dataset = dataset4 %>% 
  ...
  ### inner-join hier overbodig (want maar één bosreservaat)
