...
> Gevraagd aan Peter (mail 19/11/25)
Op dit moment uitgaan van "NA", eerder dan 0 soorten => in alle tabellen die plot wegfilteren
(anders `survey_reg_YN = FALSE`: aanpassen in  plotdetails in moederdb)
...
dataset2_0 <- add_zeros(dataset = dataset2 %>% 
                        ...
                        # period als grouping_var, anders wordt plot212 periode 2 terug toegevoegd
