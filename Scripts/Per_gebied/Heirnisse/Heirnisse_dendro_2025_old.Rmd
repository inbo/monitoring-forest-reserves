...
afwijkend_jr <- plotinfo %>% filter(year_dendro == 2014)
```

Er zijn 5 plots met een afwijkend jaartal (2014 ipv 2013): `r afwijkend_jr$plot_id`.
Deze werden alle opgemeten in sept 2014.
De andere plots overwegend jan & feb 2014.
