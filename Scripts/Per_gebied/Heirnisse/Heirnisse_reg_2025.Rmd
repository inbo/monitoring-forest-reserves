...
> OPGEPAST: er zat een bug in forrescalc => branch bugfix_Al_2025 op dit moment (19/11/2025),
tot gemerged met bugfix ...
...
nrow(checkA1) # 228 - vooral periode 1 - hier wordt dan een exact aantal gebruikt ipv een klasse
...
checkA2 <- data_regeneration %>% 
  ...
  select(all_of(select_colnames_reg))
nrow(checkA2) == 0
# !! 28 - periode 2 kernvlakte, vooral species 83 (witte els)
...
Het gaat hier (Heirnisse) om 27 records uit de kernvlakte, 2de decade.    
Vooral Witte/Grauwe els met heel veel verjonging (aantalsklasse > 100).
...
# 9 plots waar geen verjonging genoteerd werd
