...
forestreserve_folder <- "Heirnisse_DEELS"
# plot_type <- "Core area"
...
Tot nu toe werd acces gebuikt om te kijken of er voor elke soort een curve opgesteld was, en of er geen soorten geclusterd dienen te owrden.
...
nr_measured <- stems %>% 
  ...
  select(species, name_nl, everything())
