...
# resultaten
path_to_datarequest <- paste0("C:/3BR/4_", forestreserve, "/2AanmaakDHcurves/VirtualTreesHeightCurves")
...
write_csv2(overview_heights_CP,paste0(forestreserve_folder, "/2AanmaakDHcurves/overview_heights_CP.csv"))
...
write.csv2(nr_measured, paste0(forestreserve_folder, "/2AanmaakDHcurves/nr_measured_CP.csv"))
...
write.csv2(overview_HH_height, paste0(forestreserve_folder, "/2AanmaakDHcurves/overview_HH_height_CP.csv"))
```
