...
stems_height_eik <- stems_height %>% filter(name_nl == "Wilg smalbladige species")

stems_height_eik_p1 <- stems_height_eik %>% filter(period == 1)
stems_height_eik_p2 <- stems_height_eik %>% filter(period == 2)

mean(stems_height_eik_p1$height_m, na.rm = T) # 19
mean(stems_height_eik_p2$height_m, na.rm = T) # 23
