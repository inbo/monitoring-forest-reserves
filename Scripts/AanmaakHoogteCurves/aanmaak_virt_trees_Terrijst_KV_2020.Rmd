...
specieslist_coppice <- c(16, 28, 64, 69)
...
Meer metingen in 2005, te weinig in 2015 => beide gebruiken
...
mean(stems_height_beuk_p1$height_m) # 28.6
mean(stems_height_beuk_p2$height_m) # 29.2
...
mean(stems_height_esd_p1$height_m, na.rm = T) # 13.1
mean(stems_height_esd_p2$height_m, na.rm = T) # 16.9
...
mean(stems_height_eik_p1$height_m, na.rm = T) # 28.7
mean(stems_height_eik_p2$height_m, na.rm = T) # 29.6
...
Periode 1 bij lagere dbh's misschien ietsje lager?? 
