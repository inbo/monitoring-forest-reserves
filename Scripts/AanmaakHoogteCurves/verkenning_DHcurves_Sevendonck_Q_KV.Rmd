...
path_to_height_models <- paste0(forestreserve_folder, "/AanmaakDHcurves")

# dh-parameters
heightparam <- "HeightParams_Sevendonck_Q_KV.xlsx"
...
write.csv2(nr_measured, paste0(path_to_height_models, "/nr_measured_KV_Q.csv"))
...
Is er een meerwaarde om berk, zachte en ruwe berk samen te nemen? (6, 57, 86)
...
NEE, zie onderstaande grafiek.
Zachte en ruwe berk liggen te ver uit elkaar: zachte berk duidelijk lagere diameters.
Berk sluit beste aan bij Zachte berk, maar niet met zekerheid geweten.

<!-- Er verandert bijna niks voor ruwe berk (< 1 m lager), maar berk heeft betere curve. -->

```{r graph_berk_cluster}
listspecies <- c(6, 57, 86)
