...
- zie `0_16_residuals.emf`: 1 outlier van esdoorn, maar geen invloed op curve en 
mogelijks correct 
- zie `0_87_residuals.emf`: 1 outlier van zomereik, maar geen invloed op curve en 
mogelijks correct 
...
**Terrijst CP: geen extrapolaties.**
...
Plakken in excel-file "HeightParams_Terrijst_CP.xlsx" in folder ".../06_Terrijst/verwerking_2026_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET"
...
de emf-files uit ".../06_Terrijst/FMprojecten_2025/Terrijst_DHcurves_CP_22_inbo2026/InventoryAnalyst/Charts_Height_m" kopiëren naar

- ".../06_Terrijst/verwerking_2026_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET/DH_curves_CP_exp"    
- ".../06_Terrijst/verwerking_2026_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET/DH_curves_CP_log"     
...
Nu lijkt het net andersom, toch als we naar de globale R-waarde kijken.



EXP:      
- soort 24: onderschatting hogere diameters       
- soort 14 en 7: ? beetje onderschatting hogere diameters     

LOG:      
- soort 3 en 64 en 7: kleine overschatting hogere diameters     

EXP vs LOG:       
- soort 7: volgens R-waarde is exp beter (0.001!! eigenlijk +/- zelfde), visueel exp 
beter bij lagere dbh's, bij hogere gelijkaardig (exp onderschat en log overschat) => LOG      

- soort 24: volgens R-waarde is exp beter, visueel log beter bij hogere dbh's, maar niet veel verschil => EXP     
- soort 14: volgens R is log beter, maar scheelt niet veel      

- soort 3: volgens R is log beter, visueel ook => LOG     
- soort 64 volgens R is exp beter, visueel ook => EXP     

DUS: Exp heeft precies overhand, ofwel behandelen we ze niet allemaal gelijk ...      

Exp scoort vooral beter omdat de curve voor tKa heel duidelijk beter is dan de log-curve.     
...
- voor meeste soorten LOG gebruiken - cfr vorige dataverwerking én lagere R       
- met uitz voor Beuk (7), tKa (64), Grauwe abeel(24), Boskers(9), Zwarte els (89) 
en Ruwe berk (57) - lagere R        
...
Er zijn 3 soorten waar geen hoogtes gemeten zijn: Rode kornoelje. 
...
Bij de CP's van Terrijst is dit niet nodig. 
...
Html manueel kopieren naar c-schijf en naar de teamdrive (`r forestreserve_folder_teamdrive`)  

Na knitting - manueel

```{r eval = FALSE}
# Specify the path of the file you want to copy
source_file <- here::here(paste0("Scripts/AanmaakHoogteCurves/verkenning_DHcurves_", forestreserve_short, "_", plot_type, "_2026.html"))
