...
subtitle: "Everzwijnbad - kernvlakte"
author: "Anja Leyman"
date: "`r Sys.Date()`"
output: 
  html_document:
...
Zie [aanmaak_virt_trees_Everzwijnbad_CA_1e2e3eSET.html](https://drive.google.com/open?id=1BG9Diexar2ALgJ1vi8Oa0WQxs4pzR3sw&usp=drive_fs) met info over de aanmaak van de virtuele bomen.   
...
Bij gebruik van logaritmische functie:  
 ...
 - 0_16_residuals.emf voor esdoorn: geen echte outlier
 - 0_87_residuals.emf voor zomereik: geen outliers als we enkel naar eik kijken
...
Bij gebruik van exponentiële functie:  
 ...
 - 0_16_residuals.emf voor esdoorn: geen echte outlier
 - 0_24_residuals.emf voor grauwe abeel: geen outlier, kan zo hoog zijn, 38.5m bij dbh 115 cm
 - 0_83_residuals.emf voor witte els: is mogelijk, wel laag
 - 0_89_residuals.emf voor zwarte els: is mogelijk, wel laag
...
In 2021 geopteerd voor log (*"Bij de CP’s reeds gekozen voor log (exp in 2014).*
*Daar hier ook mee verder gaan."*)

R-waarde van log beter voor beuk en esdoorn (7 en 16), maar visueel niet echt beter 
(zeker niet bij esdoorn: daar overscahtting zwaarste bomen)
...
In geval van `r forestreserve` gaat het om Witte els: mochten er meer metingen van Zwarte els geweest zijn, zou ik de curve van Zwarte els overnemen, maar deze is ook maar obv één hoogte bepaald (en verschilt heel weinig).
...
Zie hoger bij "Enkel dode bomen". 
...
Geen nut om te clusteren, van elks te weinig metingen.
Witte els maar één boom, mét een hoogte.
Zwarte els lijkt hoger, maar niet geweten of Witte els ook hoger zou moeten zijn.
