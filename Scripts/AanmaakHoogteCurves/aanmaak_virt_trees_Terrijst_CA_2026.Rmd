...
Meer metingen in 2005, te weinig in 2014 en 2024 => hoogtes van de drie periodes samen gebruiken
...
```{r include=FALSE}
stems_height_tka <- stems_modeled_height %>% filter(name_nl == "Tamme kastanje")
...
write_xlsx(output, paste0(path_to_datarequest, "VirtualTreesHeightCurves/TblVirtueleTrees_KV_1e2e3eSET.xlsx"))
...
source_file <- here::here(paste0("Scripts/AanmaakHoogteCurves/aanmaak_virt_trees_Terrijst_CA_2026.html"))
