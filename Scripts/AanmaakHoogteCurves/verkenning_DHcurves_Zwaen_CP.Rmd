...
path_to_height_models <- paste0(forestreserve_folder, "/AanmaakDHcurves/Zwaenepoel_CP")

# dh-parameters
heightparam <- "HeightParams_Zwaenep_CP.xlsx"
...
Is er een meerwaarde om berk, zachte en ruwe berk samen te nemen?
...
Er verandert bijna niks voor ruwe berk, maar zachte berk en berk hebben betere curve.

```{r graph_berk_cluster}
listspecies <- c(6, 86, 57)
