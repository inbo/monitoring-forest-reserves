...
2. het checken van de curves: de globale curves (0_xx.emf) en de curves op plotniveau (`r virt_plot`_xxx.emf) worden in in FM-IA overlopen en de probleemgevallen worden in onderstaand R-script beschreven
...
Ook bij Els geen nut om te clusterejn (zie hoger).
