...
# resultaten
path_to_datarequest <- "C:/3BR/4_Heirnisse_DEELS/2AanmaakDHcurves/VirtualTreesHeightCurves"
```
...
Eventueel hadden we voor 1eSET afzonderlijke curves kunnen postellen, maar toch geopteerd om direct alle metingen samen te gooien en curves voor periode 1 en 2 samen op te stellen.
