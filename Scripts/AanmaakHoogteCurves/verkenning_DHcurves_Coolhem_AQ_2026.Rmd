...
```{r eval = FALSE}
write.xlsx(parameters, file = paste0(path_to_height_models, "HeightParams_", forestreserve_short, "_", subtype
                                     , "_", plot_type,  "_1.xlsx"), showNA = FALSE)  # row.names = TRUE geeft foutmelding

write.xlsx(parameters, file = paste0(path_to_height_models, "HeightParams_", forestreserve_short, "_", subtype
                                     , "_", plot_type,  "_2.xlsx"), showNA = FALSE)

write.xlsx(parameters, file = paste0(path_to_height_models, "HeightParams_", forestreserve_short, "_", subtype
                                     , "_", plot_type,  "_3.xlsx"), showNA = FALSE)
```
...
```{r eval = FALSE}
write.xlsx(parameters, file = paste0(path_to_heightmodels_teamdrive, "HeightParams_", forestreserve_short, "_"
                                     , subtype, "_", plot_type, "_1.xlsx"), showNA = FALSE)  # row.names = TRUE geeft foutmelding

write.xlsx(parameters, file = paste0(path_to_heightmodels_teamdrive, "HeightParams_", forestreserve_short, "_"
                                     , subtype, "_", plot_type, "_2.xlsx"), showNA = FALSE)

write.xlsx(parameters, file = paste0(path_to_heightmodels_teamdrive, "HeightParams_", forestreserve_short, "_"
                                     , subtype, "_", plot_type, "_3.xlsx"), showNA = FALSE)
```
