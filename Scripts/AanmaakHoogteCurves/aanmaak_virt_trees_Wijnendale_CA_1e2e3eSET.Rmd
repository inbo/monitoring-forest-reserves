...
Wat betreft Wijnendale KV:

- Er zijn duidelijk minder metingen gebeurd in de tweede en derde decade

- Voor de meeste boomsoorten is het een meerwaarde om hoogtes uit de drie periodes samen te nemen.

- Bij de meest voorkomende boomsoorten is er geen aanwijzing dat curves opgeschoven zijn naar boven de laatste 20 jaar.

- Enkel voor _**Tamme kastanje**_ kan het zijn dat de curve voor de derde decade beter is zonder de metingen van die ene zware kastanje.


**DUS: we opteren om alle metingen samen te gooien en curves voor de drie periodes samen op te stellen en te gebruiken voor alle decades.**
