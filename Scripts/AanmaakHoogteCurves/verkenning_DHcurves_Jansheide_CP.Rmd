...
```{r Path}
# resultaten
path_to_datarequest <- paste0(path_to_reserves, forestreserve_folder, "/verwerking_2025_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET/")
...
Zowel bij log als bij exponentiële functie:  
 ...
 - 0_7_residuals.emf voor beuk: 1 outlier: dbh 355cm en hoogte 39.6m => géén outlier 
...
Daar wordt dan automatisch de algemene curve gebruikt = OK    
