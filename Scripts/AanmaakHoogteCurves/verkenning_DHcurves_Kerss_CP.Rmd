...
path_to_height_models <- paste0(forestreserve_folder, "/AanmaakDHcurves/Kerss_CP")

# dh-parameters
heightparam <- "HeightParams_Kerss_CP.xlsx"
...
dh_kerss <- read_xlsx(paste0(path_to_height_models, "/", heightparam)) %>% 
