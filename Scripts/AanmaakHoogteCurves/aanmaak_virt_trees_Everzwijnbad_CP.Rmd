...
forestreserve_folder <- "Everzw_DEELS"
...
Bij de erraneous records (exp) zien we 6 outliers: blijkbaar zijn dat drie bomen die zowel bij 1e als 2eSET opgemeten zijn,
en zelfde hoogte toegekend gekregen hebben.
Ze bevinden zich alledrie in dezelfde plot (133).
Maar we kunnen er dus wel van uitgaan dat het correcte metingen zijn. 
