...
> nu eerst in Inv Analist - subtype A
...
Esdoorn, tKa, Vlier en Zomereik
16, 64, 69, 87 

Vlier (69): 3 m hoog => verwijderen
Zomereik (97): 20m hoog en 60 cm dbh: kan, geen grote invloed op curve
Esdoorn (16): twee smalle met hoogte > 25m, kan zijn, geen grote invloed op curve
tKa (64): vooral outliers tov andere soorten, niet voor tKa zelf

Zowel bij log als bij exponentiële functie (enkel vlier enkel bij log een outlier):  
...
bv. `r virt_plot`_xxx.emf: specifiek voor die ene plot, met ook aanduiding van de bomen 
...
**Terrijst CA: geen extrapolaties.**
...
In 2021 obv 1e en 2e SET geopteerd voor log, was toen beter dan de exp.
Nu lijkt het net andersom, toch als we naar de gesommeerde (gewogen) R-waardes kijken.

Exp scoort vooral beter omdat de curve voor Zomereik heel duidelijk beter is dan de log-curve.     
Als we die buiten beschouwing laten, is log globaal beter.
...
- voor meeste soorten LOG gebruiken - cfr vorige dataverwerking én lagere R voor 
alle bomen samen      
- met uitz voor Es (14), Grauwe abeel(24) en Zomereik (87) - lagere R        
...
## Parameters van twee subtypes samenvoegen in één file
