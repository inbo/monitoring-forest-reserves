...
# dh-parameters
heightparam <- "HeightParams_Sevendonck_A_KV.xlsx"
...
write.csv2(nr_measured, paste0(path_to_height_models, "/nr_measured_KV_A.csv"))
...
Is er een meerwaarde om smalbladige en breedbladige wilg samen te nemen? (77, 78)
...
Smalbladige wilg is gewoon iets anders, ze liggen te ver uit elkaar.
