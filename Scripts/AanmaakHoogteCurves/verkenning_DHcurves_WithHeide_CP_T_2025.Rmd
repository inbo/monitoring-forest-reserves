...
path_to_fieldmap_dhcurves <- paste0(forestreserve_folder,"/FMprojecten_2025/", forestreserve_short, "_DHcurves_", "CP_T", "_X8_inbo2020/FieldMapData_", forestreserve_short, "_DHcurves_", "CP_T", "_X8_inbo2020.accdb")
...
**Bosreservaat `r forestreserve`** - **plottype zowel CP als CA (transect)**.
...
```{r}
erraneous <- read_xlsx(paste0(path_to_datarequest, "erraneous_records_", "CP_T", ".xlsx"),
                       sheet = "Blad1")
...
```{r eval=FALSE}
write.xlsx(x = erraneous_, file = paste0(path_to_datarequest, "erraneous_records_", "CP_T", ".xlsx")
           , sheetName = "detail"
           , append = TRUE)
```
...
Twee "erraneous records" bij exp en één bij log.

Telkens Grove den: lage hoogtes bij dbh 25 en 30: heeft geen invloed op dh-curve => behouden. 
...
De globale curves (0_xx.emf) en de curves op plotniveau (299_xxx.emf.emf) worden in 
FM-IA overlopen.
...
bv. 299_xxx.emf.emf: specifiek voor die ene plot, met ook aanduiding van de bomen zonder 
...
**Withoefse heide CP's: geen echte extrapolaties **
...
Plakken in excel-file "HeightParams_Heirnisse_CP.xlsx" in folder ".../3_WithHeide_DEELS/verwerking_2024_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET"
...
de emf-files uit ".../3_WithHeide_DEELS/FMprojecten_2024/Heirnisse_DHcurves_CP_X8_inbo2020/InventoryAnalyst/Charts_Height_m" kopiëren naar

- ".../3_WithHeide_DEELS/verwerking_2024_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET/DH_curves_CP_exp"    
- ".../3_WithHeide_DEELS/verwerking_2024_1e2e3eSET/2AanmaakDHcurves_1e2e3eSET/DH_curves_CP_log"     
...
Outliers van Grove den behouden
...
In 2022 exp, nu ook beste keuze. 
...
Geen soort die enkel als dode boom voorkomt.
...
Er zijn twee soorten waar geen hoogtes van gemeten zijn: Berk en Zachte berk.  
...
=> bij Withoefse heide is het geen meerwaarde om te clusteren.


# Aanpassen parameterfile

De excel-file "HeightParams_WithHeide_CP_T.xlsx" aanpassen
...
De plotmodellen (plotID = 299) van soorten waar ook een globaal model (plotID = <ALL>) 
...
```{r}
parameters <- read_excel(path = paste0(path_to_datarequest, "HeightParams_", forestreserve_short, "_", "CP_T", ".xlsx"))
...
source_file <- here::here(paste0("Scripts/AanmaakHoogteCurves/verkenning_DHcurves_", forestreserve_short, "_", "CP_T", "_2025.html"))

# Specify the destination directory where you want to copy the file
destination_dir1 <- path_to_datarequest
destination_dir2 <- paste0(path_to_dataverwerking_teamdrive, 
                           "20_Per_gebied/2024_Withoefse_heide/02_dh_curves")
