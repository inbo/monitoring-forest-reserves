...
trees <- load_data_dendrometry(database = path_to_fieldmap_db, plottype = plot_type
...
Zit er verschil op de hoogtes van Beuk?
...
Zit er verschil op de hoogtes van Gewone es?
...
Volgens mij toch wat doorgeschoven ...
...
write_xlsx(output, paste0(path_to_datarequest, "VirtualTreesHeightCurves/TblVirtueleTrees_CP_1e2e3eSET.xlsx"))
...
source_file <- here::here(paste0("Scripts/AanmaakHoogteCurves/aanmaak_virt_trees_Terrijst_CP_2026.html"))
