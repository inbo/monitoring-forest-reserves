...
list_all <- list(
      ...
      , stat_carbone = carbon_by_reserve
...
Verwijderen van "De heide" uit de dataset, want geen onbeheer bos (geen strikt forest reserve)
...
Zitten anderzijds ook in n_obs ...
...
# info_BR
write.csv2(info_BR, paste0(path_to_datarequest, "BR_niveau/", "site_info.csv"))
...
# info_BR
write.csv2(info_BR, paste0(path_to_datarequest_gdrive, "BR_niveau/", "site_info.csv"))
