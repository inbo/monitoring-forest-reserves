...
!! doen obv dendro_per_plot
checken of daar alle plots in zitten (mbv plotinfo)

check_zero_volume <- analyseSet %>% 
  full_join(plotinfo %>% select(plot_id, period, number_of_tree_species), by = c("plot_id", "period")) %>% 
...
# TOCH WEL: VBI zal in beide periodes plots verliezen, hier is het maar één plot, één periode 
