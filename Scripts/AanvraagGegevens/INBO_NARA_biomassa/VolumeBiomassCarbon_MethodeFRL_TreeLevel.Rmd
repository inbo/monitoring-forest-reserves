...
<!-- 4) Estime un volume pour les arbres dont 20<circ<22 et certains (certifieer) autres arbres -->
...
analyseSet_0_biomassa <- zero_volume %>%
  mutate(year = year_dendro,
         ...
         StemVolume_m3_ha = 0,  # cfr methode FRL (met een volume voor dunne boompjes > 7 cm, maar volume = 0 cfr Dagnelie)
         VolumeStump_m3_ha = 0,  
...
# "BiomassAboveGr_t_ha", "CarbonAboveGr_t_ha"  : nog niet gedaan
