...
qry_standing_per_plot %>% filter(SPI_ID == 842)
qry_standing_per_plot %>% filter(LPI_ID == 171100)
```
...
# snelle check
qry_standing_per_site %>% filter(SITE_NAME == "Bos Terrijst" & INVENTORY_TYPE ==  "SPI")
qry_standing_per_site %>% filter(SITE_NAME == "Coolhembos" & INVENTORY_TYPE ==  "LPI")
```
...
source_file <- here::here(paste0("Scripts/AanvraagGegevens/INBO_Wildcard_EuFoRIa/Wildcard_Flanders_queries_extra2026.html"))
