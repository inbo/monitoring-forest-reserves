...
names(plotdata_def)
```
Nog composed_site_id & inventory_id toevoegen op einde
...
design_check <- read.table(paste0(path_to_datarequest_teamdrive
                                  , "UPLOAD_INBO_DESIGN_2026-05-05.txt")
                           , sep = " ", dec = ".")
head(design_check)
names(design_check)
...
plots_check <- read.table(paste0(path_to_datarequest_teamdrive
                                 , "UPLOAD_INBO_PLOTS_2026-05-05.txt")
                           , sep = " ", dec = ".")
head(plots_check)
names(plots_check)
...
#
trees_check <- read.table(paste0(path_to_datarequest_teamdrive
                                 , "UPLOAD_INBO_TREES_2026-05-05.txt")
                           , sep = " ", dec = ".")
...
ground_veg_check <- read.table(paste0(path_to_datarequest_teamdrive
                                      , "INBO_ground_veg_2026-05-05.txt")
                           , sep = " ", dec = ".")
