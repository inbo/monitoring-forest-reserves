...
Zie word-doc "Opmerkingen nieuwe data delivery wildcard.docx".

O.a.

- LPI_ID en SPI_ID in één kolom
- extra inventory_ID
- standing en lying in één tabel
...
trees_check <- read.table(paste0(path_to_datarequest_teamdrive
                                 , "UPLOAD_INBO_TREES_2026-04-09.txt")
                           , sep = " ", dec = ".")
...
design_check <- read.table(paste0(path_to_datarequest_teamdrive
                                  , "UPLOAD_INBO_DESIGN_2026-04-23.txt")
                           , sep = " ", dec = ".")
head(design_check)
names(design_check)
...
plots_check <- read.table(paste0(path_to_datarequest_teamdrive
                                 , "UPLOAD_INBO_PLOTS_2026-04-23.txt")
                           , sep = " ", dec = ".")
head(plots_check)
names(plots_check)
...
ground_veg_check <- read.table(paste0(path_to_datarequest_teamdrive
                                      , "INBO_ground_veg_2026-04-23.txt")
                           , sep = " ", dec = ".")
