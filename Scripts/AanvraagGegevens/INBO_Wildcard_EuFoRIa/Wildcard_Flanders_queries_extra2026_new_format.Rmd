...
#
qry_lying_check <- read.table(paste0(path_to_datarequest_teamdrive, "INBO_LYING_QUERY_2026-09-04.txt")
                           , sep = "\t", dec = ".")
head(qry_lying_check)
names(qry_lying_check)

#
qry_standing_check <- read.table(paste0(path_to_datarequest_teamdrive, "INBO_STANDING_QUERY_2026-09-04.txt")
                           , sep = "\t", dec = ".")
