...
Ik heb alles gecorrigeerd in databank, behalve de missing date en fieldteam van
regeneration, in volgende plots:
...
select_colnames_reg <- data_regeneration %>% 
  select(forest_reserve, plot_id, plottype
         , period, year, subcircle, subcirclearea_ha
         , height_class, species, nr_of_regeneration
         ) %>% 
  colnames()
