...
> TO DO: enkel weten welke XY: van shp of van tbl Fieldmap
shp sowieso voor Kluisbos
...
> Enkel nodig voor cirkelplots (samen met deadwood volume per plot (zie script staande bomen)

>Volgens Luc eerder voor controle op scherm, en volume logs per plot ter validatie


Testdata om hoeveelheid dood hout via remote sensing te bepalen.
Vraag van luc DK ism Myrte Matthijs.

Staand dood hout samen met levende bomen aangeleverd mbv script "RemoteSensing_trees_cirkelplots.Rmd". 

Dit script focust op liggend dood hout.
...
> mogelijks moeten we deze van de shapefile gebruiken, zie ander script staande bomen
