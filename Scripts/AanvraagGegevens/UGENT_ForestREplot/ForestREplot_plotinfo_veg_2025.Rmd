...
hist5_heirn <- hist %>% 
  ...
  mutate(former_landuse = case_when(
         ...
         , year_afforestation = case_when(
           hist_uitgebreid == "0000001111" ~ paste(DG3_t, MGI_t, sep="-"),
           #110011110: we veronderstellen dat dit 110011111 moet zijn
           hist_uitgebreid %in% c("0000011111", "1110011111", "0111011111", "0110011111", "0110011110", "0110011111", "0111011111") ~ paste(DG2_t, DG3_t, sep="-"),
           hist_uitgebreid %in% c("0000111111", "0110111111") ~ paste(DG1_t, DG2_t, sep="-"),
           hist_uitgebreid == "0111111111" ~ paste(Ferr_t, VDM_t, sep="-"))
         , year_mid = case_when(
           hist_uitgebreid == "0000001111" ~ (MGI_t + DG3_t)/2,
           #110011110: we veronderstellen dat dit 110011111 moet zijn
...
Hierna filteren we de periodes weg waar geen opnames gebeurd zijn.
