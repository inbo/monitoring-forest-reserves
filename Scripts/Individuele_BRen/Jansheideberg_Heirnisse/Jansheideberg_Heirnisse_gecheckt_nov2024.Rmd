...
subtitle: "Jansheideberg & Heirnisse & Withoefse heide - cirkelplots & kernvlakte"
author: "Anja Leyman"
date: "`r Sys.Date()`"
output: 
  html_document:
...
```{r Setup2}
forestreserve <- c("Jansheideberg", "Heirnisse", "Withoefse heide")   # FM-project onder folder Jansheideberg geplaatst
