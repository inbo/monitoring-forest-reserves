...
Zie files in folder [PRJ_BR_Gegevensverwerking/per_gebied/2024_Jansheideberg\01_datacontrole](https://drive.google.com/open?id=1O1wvjP4de65bKGLvMdnz6cuWnFQYX4FY&usp=drive_fs):
...
Eerste controle juni 2024 (enkel Jansheideberg):
...
```{r eval = FALSE}
# Specify the path of the file you want to copy
source_file <- here::here(paste0("Scripts/Individuele_BRen/Jansheideberg_Heirnisse/", "Jansheideberg_Heirnisse_controle_okt2024.html"))
