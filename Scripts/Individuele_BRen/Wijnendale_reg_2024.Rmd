...
```
OPGEPAST: per plot is er ook een species NA en heightclass NA, waar aantallen = 0 zijn: 
...
# warnings hebben te maken met feit dat er subplots zijn van de kernvlakte zonder species
# en dus ook zonder "plotarea"subcircle"
...
Initiële fout deels opgelost door bij `load_regeneration()` `GameImpactRegObserved = 10` te 
...
source_file <- here::here("Scripts/Individuele_BRen/Wijnendale_reg_2024.html")
