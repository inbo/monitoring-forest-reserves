...
Dit moet op niveau van bosreservaat gecheckt worden: is het OK dat game_impact genoteerd werd? (GameImpactVeg/RegObserved = 10)
...
"On same place but not coupled": misschien heeft het zin om verder te verfijnen obv NOMT?
Indien bij de tweede periode NOMT = "ingegroeide boom (prev te smal)" hoeft dit niet als 
fout weerhouden worden? 
@Peter??
...
- > 15 => dikke en lage boom    
- < 1.5 => smalle en hoge boom    
