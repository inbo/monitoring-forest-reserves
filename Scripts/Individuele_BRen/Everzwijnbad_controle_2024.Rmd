...
incorrect_data_ <- incorrect_data %>% 
  left_join(data_dendro %>% 
              select(plot_id, period, tree_measure_id, alive_dead, ind_sht_cop)) 
```
...
- game_damage_number: die NA's komen niet tot uiting? nochtas daar ook plots met 
schade aan één soort, en niks genoteerd bij andere soort
...
```{r eval = FALSE}
# Specify the path of the file you want to copy
source_file <- here::here("Scripts/Individuele_BRen/Everzwijnbad_controle_2024.html")
